...
static PyObject *__pyx_kp_u_1_6;
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_u_1_6, __pyx_k_1_6, sizeof(__pyx_k_1_6), 0, 1, 0, 0},
...
if (!__Pyx_RefNanny) {
  ...
  if (__Pyx_SetNameInClass(__pyx_t_1, __pyx_n_s_VERSION, __pyx_kp_u_1_6) < 0) __PYX_ERR(0, 9, __pyx_L1_error)
